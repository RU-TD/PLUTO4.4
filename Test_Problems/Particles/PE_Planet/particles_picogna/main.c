...
#if INCLUDE_PARTICLES == YES // Giovanni Picogna's particle implementation
  #include "particles.h"
#endif
...
/* --------------------------------------------------------
  ...
  // particle memory allocation and initialization
  #if INCLUDE_PARTICLES == YES // Giovanni Picogna's particle implementation
    ParticlesAllocateArrays();
    CreateDomainDecomposition(grd);
    ParticlesSet(grd, &data, &runtime);
    #ifdef PARALLEL
...
/* --------------------------------------------------------
  ...
  #if INCLUDE_PARTICLES == YES // Giovanni Picogna's particle implementation
    /* Perform the predictor step for particles */
    ParticlesPredictor(d->Vc, grid);
  #endif
...
/* --------------------------------------------------------
  ...
  #if INCLUDE_PARTICLES == YES // Giovanni Picogna's particle implementation
    /* Perform the corrector step for particles */
    ParticlesCorrector(d->Vc, grid);
  #endif
